...
def get_model_path(modelname):
    ...
    pretrained_dir = '/media/data2/pretrained'
    PTDICT = {
...
class BackboneBase(nn.Module):
    ...
    def __init__(self, backbone: nn.Module, train_backbone: bool, num_channels: int, return_layers: Dict, frozen_layers: bool
...
class Backbone(BackboneBase):
    ...
    def __init__(self, name: str,
        ...
        super().__init__(backbone, train_backbone, num_channels, return_layers, frozen_layers)
...
def build_backbone(args):
    ...
    if args.backbone in ['swin_B_224_22k', 'swin_B_384_22k', 'swin_L_224_22k', 'swin_L_384_22k']:
        ...
        backbone = Backbone(args.backbone, train_backbone, return_interm_layers, False, args.pretrained, args.frozen_layers)
